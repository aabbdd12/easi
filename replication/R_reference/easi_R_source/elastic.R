...
function (object = object, type = c("price", "income", "demographics"), sd = FALSE) 
{
    ...
    Result <- list(EP = EP, EP_SE = EP_SE, EPS = EPS, EPQ = EPQ, ELASTPRICE = ELASTPRICE, ELASTINCOME = ELASTINCOME, ELASTPRICE_SE = ELASTPRICE_SE, ELASTINCOME_SE = ELASTINCOME_SE, ER = ER, ER_SE = ER_SE, 
        EZ = EZ, EZ_SE = EZ_SE)
    Result
}
